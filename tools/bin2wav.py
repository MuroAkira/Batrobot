...
def main():
    ...
    ap.add_argument("-i", "--input", default="/home/ubuntu/batrobot/C/output/adc_data/adc_FM_duty40_dur2ms.bin", help="input bin path")
    ...
    ap.add_argument("-o1", "--out-wav", default="/home/ubuntu/batrobot/C/output/adc_data/adc_FM_duty40_dur2ms.wav", help="output wav (full rate)")
